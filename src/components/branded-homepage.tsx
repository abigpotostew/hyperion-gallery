    ...
    <>
      ...
      <Row>
        ...
        <Col className={'d-inline-block text-center'}>
          <span>
            ...
            />
            {"  "}
            <h1 className={'extra-large-logo d-inline-block justify-content-center'}> Hyperion</h1>
          </span>
      ...
      <Row>
        ...
        <Col sm={12} md={5} lg={4} xl={4} xxl={4} className={'align-self-center'}>
          <p>
            ...
            code.
            It is inspired by the infinite resolution of movement— from atoms, to cells, to planetary maneuvers: every
            point in time is unique.
            Hyperion, too, captures spectrums of texture and color with mathematical precision rendered in real time.
            
          </p>
          
          <p>
            Opening a portal to the next chapter of what NFTs are, this living collection is being created infinitely over time.

            Collectors and viewers experience the NFT in motion, rendered in any resolution.
            
            Each NFT combines mathematical representations of shape, color, and movement vectors, that together create art of a completely unique nature.
          </p>
        </Col>
      ...
      <Row>
        ...
        <Col sm={12} md={5} lg={4} xl={4} xxl={4} className={'text-left align-self-center'}>
          ...
          <p className={'text-left'}>
            <a href={'https://twitter.com/stewbracken'}>skymagic.eth</a> is a generative artist, professional web3 developer, and the creator of Hyperion.
          </p>
          <p className={'text-left'}>
            <a href={'https://twitter.com/stewbracken'}>nova</a> is a musician, web3, and a blockchain enthusiast, and creator of Hyperion.
          </p>
